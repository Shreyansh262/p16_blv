#!/usr/bin/env python3
"""
08_sft_single_stage.py  --  Single-stage SFT of SmolVLM2-500M-Video-Instruct
...
def main():
    ...
    parser.add_argument("--output_dir",  type=str, default="models/student/sft_single_stage")
    ...
    log_dir  = base_dir / "logs" / "sft_single_stage"
    setup_logging(log_dir)

    log.info("=" * 60)
    log.info("08_sft_single_stage.py  --  Single-stage SFT from base HF weights")
    ...
    PER_DEVICE_BS   = 8    # fall back to 6+grad_accum=3 if OOM detected on smoke test
    GRAD_ACCUM      = 2
