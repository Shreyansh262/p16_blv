        ...
        user_messages = [
            {
                ...
                "content": (
                    ...
                    + [{"type": "text", "text": "You are an audio description system for blind and low vision users. Follow these rules strictly: 1. First sentence: name the environment and say CAUTION if any hazard is within 2 meters. 2. Every object and person must have a direction (left/right/center/ahead) and distance in meters. 3. People: describe by clothing color, position, and movement direction only. 4. Present tense, active voice. Maximum 4 sentences. Every word must serve navigation. Describe this video scene for a blind user."}]
                ),
            }
        ]
...
def main():
    ...
    parser.add_argument("--output_dir",  type=str, default="models/student/sft_v2")
