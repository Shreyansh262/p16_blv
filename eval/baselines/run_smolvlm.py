#!/usr/bin/env python3
"""
Generic inference script for SmolVLM2 family (500M-base and 2.2B).
Usage: python run_smolvlm.py --model <path> --task <ocr|vqa> --gpu <id>
"""
...
if args.task == "ocr":
    ...
    for i, sample in enumerate(ds):
        ...
        results.append({"id": i, "question": quest, "gt": gt, "pred": pred})
        if i % 100 == 0:
